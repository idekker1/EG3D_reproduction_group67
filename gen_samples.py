...
def generate_images(
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        entries = [-200, -20, -10, -1, 0, 1, 10, 20, 200]
        l = [4, 18, 102, 148, 1812]
        for i in l: 
            for j in entries:
                z_copy = z.clone()      
                ...
                for angle_y, angle_p in [(.4, angle_p), (0, angle_p), (-.4, angle_p)]:
                    ...
                    ws = G.mapping(z_copy, conditioning_params, truncation_psi=truncation_psi, truncation_cutoff=truncation_cutoff)
                ...
                PIL.Image.fromarray(img[0].cpu().numpy(), 'RGB').save(f'{outdir}/rs={seed}, z[0][{i}] {j}.png')
